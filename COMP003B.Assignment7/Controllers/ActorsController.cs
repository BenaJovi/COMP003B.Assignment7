    ...
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Actors != null ? 
                          ...
                          Problem("Entity set 'WebDevAcademyContext.Actors'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ActorId,ActorName,ActorGender,ActorAge")] Actor actor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ActorId,ActorName,ActorGender,ActorAge")] Actor actor)
        {
            if (id != actor.ActorId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebDevAcademyContext.Actors'  is null.");
            }
            var actor = await _context.Actors.FindAsync(id);
            if (actor != null)
            {
